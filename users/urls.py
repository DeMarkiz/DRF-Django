...
from .views import CustomUserViewSet, PaymentViewSet, PaymentStatusAPIView, PaymentCreateAPIView
...
urlpatterns = (
    ...
    + [
        ...
        path('payments/', PaymentViewSet.as_view({'get': 'list', 'post': 'create'}), name='payments-list'),
